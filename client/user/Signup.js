    ...
    return (
        <div>
            <Card className={classes.card}>
                ...
                <CardActions>
                    <Button color="primary" variant="contained" onClick={clickSubmit} className={classes.submit}>Registrarse
                    </Button>
                </CardActions>
            </Card>
            <Dialog open={values.open} disable BackdropClick={true}>
                ...
                <DialogContent>
                    <DialogContentText>
                        Cuenta creada con éxito. Ingrese al link enviado a su correo para verificar su cuenta.
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
                    <Link to="/signin">
